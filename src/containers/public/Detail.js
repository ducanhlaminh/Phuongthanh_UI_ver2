...
const Detail = () => {
  ...
  const [votedPoint, setVotedPoint] = useState([]);
  ...
  return (
    <div className=" bg-lightGrey relative lg:bg-white">
      <div className="bg-[white] pl-[16px] ">
        <div className="lg:flex">
          ...
          <div className="lg:ml-[20px]">
            ...
            <section className="hidden lg:flex mt-[28px] mb-[20px]">
              {votedPoint.map((content,i) => {
                if(i>4) return <></>
                else
                return content==='star'?<AiFillStar className="text-yellow" size='23'></AiFillStar>:<AiFillStar className="text-darkGrey-tint" size='23'></AiFillStar>;
              })}
              <p className="text-darkGrey-tint text-[16px] ">({product.votedCounter} Đánh giá)</p>
            </section>
      ...
      <div className="h-[48px] items-center relative bg-lightGrey mx-[20px] rounded-[12px] px-[16px] mt-[55px] hidden lg:flex">
        ...
        >
          <p className="text-[16px] font-medium" style={{ userSelect: "none" }}>
            Thông tin chi tiết
          </p>
        </div>
        <div
