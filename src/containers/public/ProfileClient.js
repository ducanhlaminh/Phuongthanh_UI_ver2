...
const ProfileClient = () => {
  return (
    <div>
      ...
      <div className="w-[90%] h-[112px] bg-lightGrey rounded-[8px] flex p-[16px] gap-[16px] ml-[16px]">
        <div className="h-[80x] w-[80px]">
          <img src={image} className=" h-full w-full rounded-[50%]" />
        </div>
        <div>
            <p className="font-semibold text-[20px] text-black">Nguyen Thanh Long</p>
            <p className="font-medium text-[14px] text-lightGrey2 mt-[4px]">0134567</p>
        </div>
