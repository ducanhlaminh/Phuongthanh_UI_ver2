...
const Home = () => {
    ...
    useEffect(() => {
        ...
        dispatch(getFavoriteProducts({ limitProduct: 4, order: ['scores', 'DESC'] }))
    }, [])
        ...
        <div className='w-full'>
            <div className='md:hidden'>
                ...
                <div className='h-[56px] flex items-center justify-between w-full py-[15px] px-4'>
                    <span className='flex items-center gap-5'><BiMenuAltLeft size={26} /><span className='font-bold text-base'>Home</span></span>
                    <span className='flex items-center gap-6'>
                        <span><RiSearchLine size={24} /></span>
                        <span><VscBell size={24} /></span>
                    </span>
                </div>
            </div>
