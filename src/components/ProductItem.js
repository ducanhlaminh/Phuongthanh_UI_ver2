...
const ProductItem = ({ id,image, title, description, cost, v2 }) => {

    return (
        <Link to={`/detail/${id}`} className={`md:w-[286px] w-[45%] flex flex-col gap-2 ${v2 ? 'rounded-xl' : 'pb-[41px] rounded-md'} relative bg-white`}>
